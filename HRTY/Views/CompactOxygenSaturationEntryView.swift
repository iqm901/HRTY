...
/// Compact inline view for entering oxygen saturation (SpO2) readings
struct CompactOxygenSaturationEntryView: View {
    ...
    private var header: some View {
        HStack {
            ...
            .accessibilityLabel("Close oxygen saturation entry")
        }
    }
